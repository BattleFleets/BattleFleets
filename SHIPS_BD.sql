...
/*Обьекты Игрока*/
INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (41, 69, 10 , null, 'Sasha');
INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (42, 70, 10 , null, 'Lesha');
INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (43, 71, 10 , null, 'Nikita');
INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (44, 71, 10 , null, 'Kate');
INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (45, 73, 10 , null, 'Artem');
...
INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (27, 41, 'Sasha', null);
...
BEGIN
    FOR i IN 1..20 LOOP
        ...
        VALUES (obj_sq.NEXTVAL, 27, 8 , 11, 'Mortar');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 28, 8 , 12, 'Bombard');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 29, 8 , 12, 'Bombard');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 30, 8 , 13, 'Kulevrin');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 31, 8 , 13, 'Kulevrin');
    END LOOP;
    FOR i IN 1..10 LOOP
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 29, 8 , 11, 'Mortar');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 30, 8 , 11, 'Mortar');
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 31, 8 , 11, 'Mortar');
    END LOOP;
    FOR i IN 1..10 LOOP
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) 
        VALUES (obj_sq.NEXTVAL, 31, 8 , 11, 'Mortar');
    END LOOP;
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 48, 11, 14, 'Cannonball');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '100', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 49, 11, 15, 'Chain');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '60', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 40, 11, 16, 'Buckshot');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '50', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 46, 11, 14, 'Cannonball');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '50', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 48, 11, 15, 'Chain');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '100', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 47, 11, 16, 'Buckshot');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '100', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 49, 11, 14, 'Cannonball');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '60', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 47, 11, 15, 'Chain');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '100', null);
    INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, 49, 11, 16, 'Buckshot');
    INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (34, obj_sq.CURRVAL, '60', null);
    FOR i IN 27..31 LOOP
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, i, 7 , 9, 'Fore-mast');
        INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (26, obj_sq.CURRVAL, '18', null);
        INSERT INTO OBJECTS (OBJECT_ID, PARENT_ID, OBJECT_TYPE_ID, SOURCE_ID, NAME) VALUES (obj_sq.NEXTVAL, i, 7 , 10, 'Main-mast');
        INSERT INTO ATTRIBUTES_VALUE(ATTR_ID, OBJECT_ID, VALUE, DATE_VALUE) VALUES (26, obj_sq.CURRVAL, '19', null);
    END LOOP;
END;
/
...
CREATE OR REPLACE TRIGGER MAX_MONEY
FOR UPDATE OF VALUE ON ATTRIBUTES_VALUE COMPOUND TRIGGER moneys boolean;
  BEFORE EACH ROW IS
  BEGIN
    IF :OLD.ATTR_ID=29 AND :NEW.VALUE>2147483647
    THEN
      moneys:=true;
    END IF;
  END BEFORE EACH ROW;
  ...
  BEGIN
    IF moneys
    THEN
      UPDATE ATTRIBUTES_VALUE SET VALUE=2147483647 WHERE ATTR_ID=29 AND VALUE>2147483647;
    END IF;
  END AFTER STATEMENT;
END;
/
